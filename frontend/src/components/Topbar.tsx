  ...
  return (
    <div className="flex h-16 items-center gap-3 border-b border-slate-200 bg-white px-4 md:gap-6 md:px-7">
      ...
      <div className="relative flex shrink-0 items-center gap-2.5 md:gap-4">
        {/* Notifications/settings are secondary actions — drop them on
            narrow screens so the essential bits (tool switcher, avatar
            menu with logout) always have room. */}
        <div className="hidden h-9 w-9 items-center justify-center rounded-lg border border-slate-200 bg-slate-100 text-slate-500 sm:flex">
